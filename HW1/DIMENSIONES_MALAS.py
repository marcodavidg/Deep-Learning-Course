...
parameters = L_layer_model(X, Y, layers_dims, learning_rate = 0.1, num_iterations = 250, print_cost = True)
print(parameters["b1"])
# predict(X_test, Y_test, parameters)


ESTE ES EL QUE SIRVE POR ALGUNA RAZON CON LAS DIMENSIONES MALAS, PERO NO PUEDO PREDICT()